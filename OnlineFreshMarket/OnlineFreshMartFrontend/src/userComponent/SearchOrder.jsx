...
const SearchOrder = () => {
  ...
  // Arrays to hold possible values for delivery status and time
  const deliveryStatus = ["Delivered", "On the Way", "Processing"];
  const deliveryTime = ["Morning", "Afternoon", "Evening", "Night"];

  // State to hold the updated order delivery status
  ...
  // Function to handle changes in the order delivery status fields
