...
const MyDeliveries = () => {
  // Retrieve active delivery person from session storage
  const delivery = JSON.parse(sessionStorage.getItem("active-delivery"));

  // State to store delivery order data
  const [myOrderData, setMyOrderData] = useState([]);

  // Fetch delivery orders when the component mounts
  useEffect(() => {
  ...
  // Fetch delivery orders for the current delivery person
